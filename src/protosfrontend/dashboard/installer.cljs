              ...
              (let [installers @(rf/subscribe [:installers])]
                ...
                [:tr {:key id}
                  [:td {:class "text-center"}
                    [:div {:class "avatar d-block bg-white" :style {:background-image "url(images/installer-generic.svg)" :background-size "60%"}}]]
                  [:td
      ...
      [:div {:class "col-12"}
        ...
        [:div {:class "card"}
          [:div {:class "card-header"}
            [:div {:class "avatar d-block bg-white mr-3" :style {:background-image "url(images/installer-generic.svg)" :background-size "60%"}}]
